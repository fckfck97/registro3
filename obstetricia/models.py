...
class Orden_medica_parto(models.Model):
	...
	orden_seis = models.CharField(max_length=50,null=True,blank=True)
	orden_siete = models.CharField(max_length=50,null=True,blank=True)
	orden_ocho = models.CharField(max_length=50,null=True,blank=True)
	orden_nueve = models.CharField(max_length=50,null=True,blank=True)
	orden_diez = models.CharField(max_length=50,null=True,blank=True)
	fecha = models.CharField(max_length=50)
	medico_nombre = models.CharField(max_length=50)
	medico_apellido = models.CharField(max_length=50)
	genero = models.CharField(max_length=10)
